...
// 🌟 MAKE A COMMIT: "Completed prompt 2"
...
// 🌟 did prompt 3 not sure if its correct
...
// 🌟 MAKE A COMMIT: "Completed prompt 4"
...
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER! prompt5()
prompt5()
...
function prompt9() {
  const starWars = ["Han", "C3PO", "R2D2", "Luke", "Leia", "Anakin"]; 
  for (let i= 1; i < starWars.length; i++) {
...
const lastValueInNums = nums[nums.length - 1];
