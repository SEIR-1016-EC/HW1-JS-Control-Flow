 ...
 */
prompt9(); // Call the function to execute the code
...
function prompt11() {
  ...
  const isOddLength = nums.length % 2 === 1;
  const median = isOddLength ? nums[middleIndex] : (nums[middleIndex - 1] + nums[middleIndex]) / 2;
