...
function prompt9() {
  // YOUR CODE HERE
  console.log("0."+ starWars[0]);
  console.log("1."+starWars[1]);
  console.log("2."+starWars[2]);
  console.log("3."+starWars[3]);
  console.log("4."+starWars[4]);
  console.log("5."+starWars[5]);
}
...
function prompt11() {
  let median; //assign the number at the middle position of the sorted way 
  // YOUR CODE HERE

  nums.sort()
  console.log(nums)
  console.log("median", nums[12])

  
median= [Math.floor(nums.length/2)]

  //find middle position of the sorted list (nums)

  console.log(median);
}
// COMMENT IN THE BELOW LINE OF CODE T`O TEST YOUR OUTPUT IN THE BROWSER!
// prompt11();
