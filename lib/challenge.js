...
function prompt8() {
  ...
  // Unable to get code to run? Really not sure what the problem is here? // 
...
function prompt13(alphabets) {
  // YOUR CODE HERE
  if (type of(alphabets == "object" {
    for (var i = 0; i < arr. length; i++) {
      prompt13(alphabets[i]);
    }
    else console.log(alphabets);
  })
