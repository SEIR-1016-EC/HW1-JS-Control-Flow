...
//console.log('prompt8 begins here');
//  define someNumber here
//var someNumber;

//function prompt8(someNumber = Math.floor(Math.random() * (100 - 0) + 0)) {
...
//            console.log("The number is medium sized." + someNumber);
...
//console.log('prompt 9  Begins here');
...
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER!
// prompt9();
//  console.log('prompt 9 ends here');
 ...
 */
//console.log('prompt 10 begins here');
...
//console.log('prompt 10 ends here');
...
//i searched for a way to sort an array on the mdn web docs https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort
// i eventually found the sort() function.

//I honestly don't know if I solved this right. This is as far as I got with what I understood.
  nums.sort(); //sort the array so its arranged from lowest values to highest

  console.log(nums);

  console.log(nums.length/2); //This returns the int "12.5". I'm not sure if this is how to find the middle of an array. It's the closest I could think of.
  
  console.log(median = Math.floor(nums.length/2)); //since 12.5 isnt a number in the array I used Math.floor to round the number

  console.log(median);
  console.log(nums[median]); //this produces "15" as a value which seems to be the mid point of the array. This is as far as I got trying to find the median.
  console.log('I think 15 is the median value of the array');
}
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER!
 prompt11();
