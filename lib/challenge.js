...
function prompt11() {
  ...
  nums = nums.sort();
  if (nums.length % 2 === 0) {
    const midNumPosition1 = Math.floor(nums.length / 2);
    const midNumPosition2 = midNumPosition1 + 1;
    median = (nums[midNumPosition1] + nums[midNumPosition2]) / 2;
  } else {
    const midNumberPosition = Math.floor(nums.length / 2) + 1;
...
// const a = nestedArrays[0];
// const b = nestedArrays[1];
// const c = nestedArrays[2];
// function prompt13() {
//   for (let i = 0; i < a.length; i++) {
//     for (let j = 0; j < b.length; j++) {
//       for (let k = 0; k < c.length; k++) {
//         console.log(`i: ${a[i]} / j: ${b[j]} /k: ${c[k]}`);
//       }
//     }
//   }
// }
