...
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER!//prompt2();
...
const max_num = 99
var someNumber = Math.floor(Math.random() * max_num + 1);
...
function prompt8() {
    if (someNumber < 30) {
      ...
      console.log(someNumber, "We've got a big DADDY one now!!!");
    }
...
// YOUR CODE HERE
// let text = ""; 
// starWars.forEach(prompt9);
// console.log(starWars)
// for (let x of s) {
  // document.querySelector(starWars).innerHTML += x + "<br>";
